...
<body>
      ...
      <div id="menubar">
        <ul class="menu">
          ...
          <li><a href="#">Aluno x Turma</a>
          	<ul>
          		<li class="selected"><a href="AlunoTurmaController?acao=cadastro">Matricular</a></li>
    ...
    <div class="form_settings">
    	<form action="salvaCadastroAluTur.jsp" method="post">
            <p><span>CPF do Aluno</span><input class="contact" type="text" name="cpf"/></p>
            <p><span>Código da Turma</span><input class="contact" type="text" name="codigo"/></p>
            <p style="padding-top: 15px"><span>&nbsp;</span><input class="submit" type="submit" name="enviar" value="Matricular" /></p>
         </form>
    </div>
    </div>
