<%@page import="br.com.body.jdbc.AlunoTurmaDAO"%>
...
<body>
	...
	alunoTurma.setCpfAluno(cpfAluno);
	alunoTurma.setCodTurma(codTurma);
	
	AlunoTurmaDAO alutuDAO = new AlunoTurmaDAO();
	alutuDAO.cadastraAlunoTurma(alunoTurma);
	AlunoTurma alutuOK = alutuDAO.buscaAlunoTurma(alunoTurma.getCpfAluno());
