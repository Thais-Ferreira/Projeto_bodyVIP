...
<body>
    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul class="menu">
          ...
          <li><a href="#">Turmas</a>
          	<ul>
          		<li class="selected"><a href="TurmaController?acao=cadastro">Cadastrar</a></li>
    ...
    <div class="form_settings">
    	<form action="salvaCadastroTurma.jsp" method="post">
            ...
            <p><span>Número de Vagas</span><input class="contact" type="text" name="vagas"/></p>
            <p><span>Dia da Semana</span><input class="contact" type="text" name="semana"/></p>
            <p><span>Hora Início</span><input class="contact" type="text" name="inicio"/></p>
