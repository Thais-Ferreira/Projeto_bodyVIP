...
<body>
    ...
    <div class="form_settings">
		...
		<form action="ProfessorController" method="post">
			...
			<p><span>Nome</span>
			<input class="contact" type="text" name="nome" value="<%= professor.getNome()%>"></p>
			<p><span>CPF</span>
			<input class="contact" type="text" name="cpf" value="<%= professor.getCpf()%>"></p>
			<p><span>E-mail</span>
			<input class="contact" type="text" name="email" value="<%= professor.getEmail()%>"></p>
